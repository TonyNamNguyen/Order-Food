                            ...
                            <div class="dropdown-menu animated zoomIn">
                                <ul class="mega-dropdown-menu row">
                                    ...
                                    <li class="col-lg-3  m-b-30">
                                        <h4 class="m-b-20">Liên hệ với chúng tôi</h4>
                            
                                        <form>
                                            <div class="form-group">
                                                <input type="text" class="form-control" id="exampleInputname1" placeholder="Nhập tên"> </div>
                                            <div class="form-group">
                                                <input type="email" class="form-control" placeholder="Nhập Email"> </div>
                                            <div class="form-group">
                                    ...
                                    <li class="col-lg-3 col-xlg-3 m-b-30">
                                        <h4 class="m-b-20">Ví dụ</h4>
                             
                                        <ul class="list-style-none">
                                            <li><a href="javascript:void(0)"><i class="fa fa-check text-success"></i> Đây là thẻ a</a></li>
                                            <li><a href="javascript:void(0)"><i class="fa fa-check text-success"></i> Đây là thẻ a</a></li>
                                            <li><a href="javascript:void(0)"><i class="fa fa-check text-success"></i> Đây là thẻ a</a></li>
                                            <li><a href="javascript:void(0)"><i class="fa fa-check text-success"></i> Đây là thẻ a</a></li>
                                            <li><a href="javascript:void(0)"><i class="fa fa-check text-success"></i> Đây là thẻ a</a></li>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                   <ul id="sidebarnav">
                        ...
                        <li> <a href="dashboard.php"><i class="fa fa-tachometer"></i><span>Bảng điểu khiển</span></a></li>
                      ...
                      <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-cutlery" aria-hidden="true"></i><span class="hide-menu">Thực đơn</span></a>
                            <ul aria-expanded="false" class="collapse">
								<li><a href="all_menu.php">Tất cả món ăn</a></li>
								<li><a href="add_menu.php">Tạo món ăn</a></li>
                            ...
                            <div class="card-body">
                                <form action='' method='post'  enctype="multipart/form-data">
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="res_name" value="<?php echo $row['title'];  ?>" class="form-control" placeholder="VD: Nhà hàng Sườn nướng Hàn Quốc">
                                                   </div>
                                            </div>
                                   
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    <label class="control-label">E-mail doang nghiệp</label>
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="phone" class="form-control" value="<?php echo $row['phone'];  ?>" placeholder="VD: 0909 000 xxx">
                                                   </div>
                                            </div>
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <a href="all_restaurant.php" class="btn btn-inverse">Hủy</a>
                                    </div>
                                </form>
                            </div>
                        </div>
                    </div>
					<footer class="footer"> © 2024 - DoubleT&L</footer>
                </div>
