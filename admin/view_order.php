                                        ...
                                        <tbody>
                                           <?php
											...
											<tr>
												    ...
												    <td><center>đ<?php echo $rows['price']; ?></center></td>
											...
											<tr>
													...
													<?php 
																			...
																			{
																			?>
																			<td> <center><button type="button" class="btn btn-info"><span class="fa fa-bars"  aria-hidden="true" ></span> Chờ duyệt</button></center></td>
																		   <?php 
																			  }
																			...
																			if($status=="rejected")
																				{
																			?>
																			<td>  <center><button type="button" class="btn btn-danger"> <i class="fa fa-close"></i> Đã hủy</button> </center></td> 
																			<?php 
																			} 
																			?>
