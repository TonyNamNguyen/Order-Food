                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        <ul class="nav navbar-nav">
							...
							<?php
						if(empty($_SESSION["user_id"])) // nếu người dùng không đăng nhập
							{
        ...
        <section class="hero bg-image" data-image-src="images/img/pimg.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Simple order, quick delivery! </h1>
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span style="color:white;">1. </span>Chọn nhà hàng</h4> </div>
                        ...
                        <div class="step-item step2">
                            ...
                            <h4><span style="color:white;">2. </span>Chọn món</h4> </div>
                        ...
                        <div class="step-item step3">
                            ...
                            <h4><span style="color:white;">3. </span>Giao hàng</h4> </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    ...
                    <p class="lead">Top 6 hương vị mang đến mọi nhà</p>
                </div>
                <div class="row">
						<?php 					
            ...
            <div class="container">
                    ...
                    <div class="row how-it-works-solution">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <h3>Chọn món ăn</h3>
                                <p>Chúng tôi đã hỗ trợ với nhiều nhà hàng giao hàng trực tuyến.</p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <h3>Nhận hàng hoặc giao hàng</h3>
                                <p>Thưởng thức bữa ăn của bạn! </p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <p class="pay-info">Thanh toán khi giao hàng</p>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Địa chỉ</h5>
                                    <p>22 Phan Van Hon, Quan 12</p>
                                    <h5>SĐT: 0947 714 xxx</a></h5> </div>
